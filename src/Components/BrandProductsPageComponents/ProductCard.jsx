...
const ProductCard = ({ product }) => {
   ...
   return (
      <div>
         <div className=" sm:flex w-full max-w-[48rem] flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md ">
            <figure className=" sm:w-2/5  bg-black  rounded-r-none bg-white bg-clip-border text-gray-700">
               <img
                  src={productImage}
                  alt="image"
                  className="h-full w-full rounded-t-xl sm:rounded-l-xl object-cover object-center"
               />
            </figure>
