...
const Signup = () => {
   ...
   return (
      <div className="flex min-h-screen  items-center justify-center py-[150px]">
            ...
            <div className=" pb-10 px-5 sm:px-10 flex  w-full flex-col rounded-3xl">
               <form onSubmit={handleSignUp} className="text-center">
                  ...
                  <p className="gap-2 text-center text-white">
                     ...
                     <Link to="/signin" className="font-semibold text-blue-900 hover:text-blue-600"> SignIn</Link>
                  </p>
               </form>
